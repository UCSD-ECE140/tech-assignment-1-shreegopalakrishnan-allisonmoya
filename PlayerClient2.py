...
if __name__ == '__main__':
    ...
    client = paho.Client(callback_api_version=paho.CallbackAPIVersion.VERSION1, client_id="Player2_aut", userdata=None, protocol=paho.MQTTv5)
    ...
    while not game_over:
        ...
        client.publish(f"games/{lobby_name}/{player_2}/move", next_m)
        time.sleep(10)
